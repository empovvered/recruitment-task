...
Proof of concept built on Next.js 16 (App Router), React 19 and Tailwind CSS 4. The developer tooling —
Prettier, ESLint, Conventional Commits and git hooks — mirrors the conventions used in the main frontend
project, trimmed to what a POC actually needs.
